       ...
       */
        ...
        handlePress = event => {
            ...
            if (active) {
                ...
                this.helper.style.top = `${this.boundingClientRect.top -
                    margin.top}px`;
        ...
        autoscroll = () => {
            ...
            if (translate.y >= this.maxTranslate.y - this.height / 2) {
                ...
                speed.x =
                    acceleration.x *
                    Math.abs(
                        (this.maxTranslate.x - this.width / 2 - translate.x) /
                            this.width
                    );
                ...
                speed.x =
                    acceleration.x *
                    Math.abs(
                        (translate.x - this.width / 2 - this.minTranslate.x) /
                            this.width
                    );
            }
