...
| items [REQUIRED]           | Array             |                                                                                                            | Array containing the elements you want to be sorted in this container, can be an array of object/strings/number. **NOTE:** If passing an array of **objects** (`{}`), each of them must contains an **unique** `id` property.                                                                                                                                                                                                                                          |
...
| onSortSwap                 | Function          |                                                                                                            | Callback that is invoked when sorting an item to an another `SortableContainer`. Invoked by `handleSortSwap` methond bound on a `SortableContainer`. `function({index, item})`                                                                                                                                                                                                                                                                                         |
| useDragHandle              | Boolean           | `false`                                                                                                    | If you're using the `SortableHandle` HOC, set this to `true`                                                                                                                                                                                                                                                                                                                                                                                                           |
| animateNodes               | Boolean           | `true`                                                                                                     | Whether node position should be animated during the DND                                                                                                                                                                                                                                                                                                                                                                                                                |
