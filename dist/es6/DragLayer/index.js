...
import { events, vendorPrefix, getPosition, getEdgeOffset, getElementMargin, clamp } from '../utils';
...
var DragLayer = function () {
    ...
    _createClass(DragLayer, [{
        ...
        value: function updateTargetContainer(e) {
            ...
            var closest = this.lists[closestRect(x, y, this.lists.map(function (l) {
                return l.container;
            }))];
