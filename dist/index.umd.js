(function(global, factory) {
  ...
  findIndex =
    findIndex && findIndex.hasOwnProperty('default')
      ? findIndex['default']
      : findIndex;
  isPlainObject =
    isPlainObject && isPlainObject.hasOwnProperty('default')
      ? isPlainObject['default']
      : isPlainObject;
  PropTypes =
    PropTypes && PropTypes.hasOwnProperty('default')
      ...
      : PropTypes;
  invariant =
    invariant && invariant.hasOwnProperty('default')
      ? invariant['default']
      : invariant;
      ...
      (_temp = _class = /*@__PURE__*/ (function(superclass) {
        ...
        WithSortableContainer.prototype.componentDidMount = function componentDidMount() {
          ...
          Promise.resolve(container).then(function(containerNode) {
            ...
            var contentWindow =
              this$1.props.contentWindow ||
              this$1.document.defaultView ||
              window;
