	        ...
	        function _class(props) {
	            ...
	            _this.handlePress = function (event) {
	                ...
	                if (active) {
	                    ...
	                    var clonedFields = [].concat((0, _toConsumableArray3.default)(clonedNode.querySelectorAll('input, textarea, select, canvas'))); // Convert NodeList to Array
	        ...
	        (0, _createClass3.default)(_class, [{
	            ...
	            value: function getLockPixelOffsets() {
	                ...
	                return [(0, _utils.getLockPixelOffset)({
	                    ...
	                    width: width,
	                    height: height
	                }), (0, _utils.getLockPixelOffset)({ lockOffset: maxLockOffset, width: width, height: height })];
	            }
	        }, {
	            key: 'updatePosition',
